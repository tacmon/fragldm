...
# 设置可调整的参数（可根据需要修改）
EXP_NAME="scaffold_alpha_bs64_nf192_nlayers9_lr1e-4_noise1e-5_steps1000_poly2_l2_latent1_ema0.9999_normalize181_clipgradTrue_high"
N_EPOCHS=3000
BATCH_SIZE=64
TEST_EPOCHS=20
NOISE_RATIO=0.8
...
echo -e "${GREEN}启动GeoLDM模型训练 - 骨架约束 + Alpha条件分子生成${NC}"
...
python main_qm9.py \
  ...
  --nf 192 \
  --n_layers 9 \
  --ae_path "outputs/vae_alpha_bs64_nf192_nlayers9_lr1e-4/" \
